...
function install_dependants()
{
    ...
    QT_DEPS="Qt5Core.dll Qt5Gui.dll Qt5Widgets.dll Qt5PrintSupport.dll libicuin58.dll libicuuc58.dll libicudt58.dll libpcre16-0.dll libpng16-16.dll qscintilla2.dll"
